...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, VOL_METER_Pin|R_RECEIVER_Pin);

    HAL_GPIO_DeInit(RF_RECEIVER_GPIO_Port, RF_RECEIVER_Pin);

    HAL_GPIO_DeInit(GPIOB, L_RECEIVER_Pin|LF_RECEIVER_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, CLK_Pin|DATA_IN_Pin);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, BUZZER_Pin|GPIO_PIN_15);
