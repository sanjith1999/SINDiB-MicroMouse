...
int main(void) {
	...
	/* USER CODE BEGIN 2 */
	int32_t right_encoderPosition = 0;
	int32_t left_encoderPosition = 0;
...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOC,
			RF_EMITTER_Pin | D_C_Pin | DIAGONAL_EMITTER_Pin | CE_Pin
	...
	/*Configure GPIO pins : RF_EMITTER_Pin D_C_Pin DIAGONAL_EMITTER_Pin CE_Pin
	 LF_EMITTER_Pin CS_Pin LED10_Pin LED3_Pin
	 LED4_Pin LED5_Pin */
	GPIO_InitStruct.Pin = RF_EMITTER_Pin | D_C_Pin | DIAGONAL_EMITTER_Pin
			| CE_Pin | LF_EMITTER_Pin | CS_Pin | LED10_Pin | LED3_Pin | LED4_Pin
			| LED5_Pin;
